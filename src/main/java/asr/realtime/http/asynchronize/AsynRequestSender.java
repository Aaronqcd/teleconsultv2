 ...
 */
package asr.realtime.http.asynchronize;

import static asr.realtime.config.AsrGlobelConfig.CUT_LENGTH;

import java.util.ArrayList;
import java.util.List;
import asr.realtime.http.base.HttpRequester;
import asr.realtime.model.request.RasrBytesRequest;
import asr.realtime.model.response.VoiceResponse;
import asr.realtime.utils.ByteUtils;
