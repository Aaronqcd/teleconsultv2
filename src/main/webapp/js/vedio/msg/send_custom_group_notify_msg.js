...
//发送自定义群系统通知
var sendCustomGroupNotify = function (msgContent, callbackList) {

    var groupId = meetingConfig.roomID;
    var content = !msgContent ? $("#sgsm_content").val() : JSON.stringify(msgContent);
    ...
    webim.sendCustomGroupNotify(
        options,
        function (resp) {
            console.log("send customer group message success", resp)
