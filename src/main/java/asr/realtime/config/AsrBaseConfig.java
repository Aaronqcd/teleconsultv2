...
public class AsrBaseConfig {
    ...
    static {
    	ResourceBundle bundle = ResourceBundle.getBundle("properties/asr");
    	AsrBaseConfig.secretId = bundle.getString("tencent.SecretId");
    	AsrBaseConfig.secretKey = bundle.getString("tencent.SecretKey");
    	AsrBaseConfig.appId = bundle.getString("tencent.AppID");
    }
