...
public class Node
{
    ...
    private String fileSourceMeeting;
	...
	public String getFileSourceMeeting() {
		return fileSourceMeeting;
	}

	public void setFileSourceMeeting(String fileSourceMeeting) {
		this.fileSourceMeeting = fileSourceMeeting;
	}
