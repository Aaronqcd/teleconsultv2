...
$(function() {
	...
	$
			.ajax({
				url : '/teleconsult/homeController/playVideo.ajax',
				type : 'POST',
				dataType : 'text',
				data : {
					fileId : fileId
	...
	$("#playerbox")
			.html(
					"<video id='kiftplayer' class='video-js col-md-12' controls preload='auto' height='500'>"
							+ "<source src='/teleconsult/diskResourceController/getResource.do?fid="
...
function doTranscode() {
	tReq=$.ajax({
		url : '/teleconsult/diskResourceController/getVideoTranscodeStatus.ajax',
		type : 'POST',
		dataType : 'text',
		data : {
			fileId : f.fileId
