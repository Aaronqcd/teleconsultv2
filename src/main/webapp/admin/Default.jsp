...
<div class="layui-layout layui-layout-admin">
  <div class="layui-header">
    ...
    <ul class="layui-nav layui-layout-left" id="bodyUl"  style="padding: 0;">
      <li class="layui-nav-item layui-this" onclick="sessionStorage.setItem('currentPage_'+currentUser,$(this).children('a').attr('href'));"><a href="UserManage" target="mainIframe"><div class="top-nav-icon"><i class="layui-icon layui-icon-group"></i></div>用户管理</a></li>
      <li class="layui-nav-item" onclick="sessionStorage.setItem('currentPage_'+currentUser,$(this).children('a').attr('href'));"><a href="MeetingManage" target="mainIframe"><div class="top-nav-icon"><i class="layui-icon layui-icon-template-1"></i></div>会诊管理</a></li>
      <li class="layui-nav-item" onclick="sessionStorage.setItem('currentPage_'+currentUser,$(this).children('a').attr('href'));"><a href="MeetingCound" target="mainIframe"><div class="top-nav-icon"><i class="layui-icon layui-icon-share"></i></div>会诊统计</a></li>
...
var currentUrl = (sessionStorage.getItem("currentPage_"+currentUser)?sessionStorage.getItem("currentPage_"+getUrlParam("currentUser")):'MeetingManage');
document.getElementById('iframe').src=document.location.origin+'<%=this.getServletContext().getContextPath()%>'+"/admin/"+currentUrl;
